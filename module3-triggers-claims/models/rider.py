"""
models/rider.py  (Module 3 — Triggers & Claims)
------------------------------------------------
Read-only ORM definitions for riders and zones.
Module 1 owns the schema and migrations; Module 3 reads these tables.
...
class Zone(Base):
    ...
    Module 1 owns it; Module 3 reads it for zone lookups.
    """
    __tablename__ = "zones"
    ...
    # Back-references (needed so SQLAlchemy relationship resolution works)
...
class Rider(Base):
    """
    Core rider identity table.
    Module 1 owns it; Module 3 reads it for eligibility checks.
    """
    ...
    def to_dict(self):
        ...
        return {
            ...
            "daily_income_history":     self.daily_income_history if self.daily_income_history is not None else [],
